...
from asr_rl_pk.modules.actor_critic import ActorCritic
from asr_rl_pk.modules.actor_critic_recurrent import ActorCriticRecurrent
# from asr_rl_pk.modules.deterministic_policy import DeterministicPolicyMixin
from asr_rl_pk.modules.conv2d import Conv2dHeadModel
from asr_rl_pk.utils.utils import get_obs_slice
...
class VisualActorCriticRecurrent(VisualActorCriticMixin, ActorCriticRecurrent):
    pass

class VisualActorCritic(VisualActorCriticMixin, ActorCritic):
    pass

# for distillation or student-teacher training
"""
we need to keep the original RNN policy structure, 
and only add the visual encoder as an additional module, 
without changing the input/output of the original actor-critic networks. 
The VisualActorCriticMixin is designed for this purpose, 
which can be easily combined with both ActorCritic and ActorCriticRecurrent, 
and can also be used in deterministic policy if needed.
"""
