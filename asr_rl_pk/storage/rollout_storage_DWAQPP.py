...
class RolloutStorageDWAQPP:
    class Transition:
        def __init__(self):
            ...
            self.proprio_hist_for_mixer = None
            self.visual_hist_for_mixer = None
    ...
    def __init__(
        ...
        self.proprio_hist_for_mixer = torch.zeros(
            num_transitions_per_env,
            num_envs,
            self.hist_length,
            self.hist_length,
        ...
        self.visual_hist_for_mixer = torch.zeros(
            num_transitions_per_env,
            num_envs,
            self.hist_length,
            *visual_obs_shape,
        ...
        self.visual_observations = torch.zeros(
            num_transitions_per_env, num_envs, *visual_obs_shape, device=self.device
        )
    ...
    def add_transitions(self, transition: Transition):
        ...
        self.visual_observations[self.step].copy_(transition.visual_obs)
        self.proprio_hist_for_mixer[self.step].copy_(transition.proprio_hist_for_mixer)
        self.visual_hist_for_mixer[self.step].copy_(transition.visual_hist_for_mixer)
    ...
    def mini_batch_generator(self, num_mini_batches, num_epochs=8):
        ...
        visual_observations = self.visual_observations.flatten(0, 1)
        proprio_hist_for_mixer = self.proprio_hist_for_mixer.flatten(0, 1)
        visual_hist_for_mixer = self.visual_hist_for_mixer.flatten(0, 1)
        ...
        for epoch in range(num_epochs):
            for i in range(num_mini_batches):
                ...
                visual_obs_batch = visual_observations[batch_idx]
                proprio_hist_for_mixer_batch = proprio_hist_for_mixer[batch_idx]
                visual_hist_for_mixer_batch = visual_hist_for_mixer[batch_idx]
